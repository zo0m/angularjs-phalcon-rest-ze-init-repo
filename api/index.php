...
use Phalcon\DI\FactoryDefault as DefaultDI,
    ...
    Phalcon\Db\Adapter\Pdo\Sqlite as Sqlite;
...
$loader->registerNamespaces(array(
	'App\Models'                => $config->phalconRest->modelsDir,
	'PhalconRest\Models'        => $config->phalconRest->modelsDir,
	'PhalconRest\Controllers'   => $config->phalconRest->controllersDir,
	'PhalconRest\Exceptions'    => $config->phalconRest->exceptionsDir,
	'PhalconRest\Responses'     => $config->phalconRest->responsesDir
))->register();
...
$di->set('collections', function() use ($config) {
	return include($config->phalconRest->routesDir . 'routeLoader.php');
});
